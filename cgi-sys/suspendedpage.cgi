...
<script type="text/javascript">window.addEventListener('DOMContentLoaded',function(){var v=archive_analytics.values;v.service='wb';v.server_name='wwwb-app104.us.archive.org';v.server_ms=194;archive_analytics.send_pageview({});});</script><script type="text/javascript" src="/_static/js/playback.bundle.js?v=SOX25l-I" charset="utf-8"></script>
<script type="text/javascript" src="/_static/js/wombat.js?v=cRqOKCOw" charset="utf-8"></script>
<script type="text/javascript">
  __wm.init("https://web.archive.org/web");
  __wm.wombat("http://besthairstraightenerdeal.com/cgi-sys/suspendedpage.cgi","20180826131038","https://web.archive.org/","web","/_static/",
	      "1535289038");
</script>
...
<!-- End Wayback Rewrite JS Include -->
    ...
    <link rel="stylesheet" href="//web.archive.org/web/20180826131038cs_/http://use.fontawesome.com/releases/v5.0.6/css/all.css">
    <style type="text/css">
        body {
...
<!--
     FILE ARCHIVED ON 13:10:38 Aug 26, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 06:15:02 Jan 04, 2021.
...
<!--
playback timings (ms):
  PetaboxLoader3.datanode: 84.001 (4)
  exclusion.robots.policy: 0.199
  RedisCDXSource: 0.711
  PetaboxLoader3.resolve: 43.125
  exclusion.robots: 0.213
  captures_list: 91.082
  load_resource: 96.894
  LoadShardBlock: 51.664 (3)
  CDXLines.iter: 34.158 (3)
  esindex: 0.014
-->